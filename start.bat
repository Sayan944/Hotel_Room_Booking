...
start "Hotel Backend API" /D "C:\Users\sampu\HotelRoomBooking\backend" cmd /k "node server.js"

REM Start Frontend React App (Port 5173)
start "Hotel Frontend App" /D "C:\Users\sampu\HotelRoomBooking\frontend" cmd /k "npm run dev"
